...
void ReportServices::JAUSApplicationLayerHeader::HeaderRec::setParent(JAUSApplicationLayerHeader* parent)
{
	m_parent = parent;
}

void ReportServices::JAUSApplicationLayerHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
void ReportServices::JAUSApplicationLayerHeader::setParentPresenceVector()
{
